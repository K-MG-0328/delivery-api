...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = -269563180L;
    ...
    public final ListPath<CartItemOption, QCartItemOption> options = this.<CartItemOption, QCartItemOption>createList("options", CartItemOption.class, QCartItemOption.class, PathInits.DIRECT2);
