package com.github.mingyu.fooddeliveryapi.delivery.adapter.in.web;
...
public class RiderDeliveryController {
    ...
    public void completeDelivery(@PathVariable String orderId) {
    ...
    public void cancelDelivery(@PathVariable String orderId) {
