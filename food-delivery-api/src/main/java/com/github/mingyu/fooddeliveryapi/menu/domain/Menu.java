...
public class Menu {
    ...
    public void update(String name, Integer price, MenuStatus status, List<MenuOption> options) {
        this.name = name;
        this.price = price;
        this.status = status;
    ...
    public void updateOptions(List<MenuOption> newOptions) {
        // 1. 현재 옵션을 Map으로 변환
        ...
        for (MenuOption param : newOptions) {
